...
const Add = () => {
        ...
        fetch("https://pets.сделай.site/api/pets", requestOptions)
            ...
            .then(result => {
                ...
                if (result === 200) {
                    ...
                    blocks.current.style.background = "#eb889f"
    ...
    return(
        <div>
            ...
            <h2 className="text-center text-white bg-primary " >Добавить объявление</h2>
            ...
            <form className="contei w-50 m-auto p-5" id="dobav"  noValidate onSubmit={dobav} >
                ...
                <div className="d-flex justify-content-center align-items-center">
                    <button type="submit" className="btn text-white bg-primary ">Выложить объявление</button>
                </div>
            </form>
