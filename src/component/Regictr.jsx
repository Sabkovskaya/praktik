            ...
            <div style={{ "minHeight": "70vh" }}>
                <form className="w-50 m-auto p-5 needs-validation" style={{ "min-width": "300px" }} noValidate onSubmit={sign} id='forma'>
                    ...
                    <div className="mb-3 form-check">
                        ...
                        <label className="form-check-label" htmlFor="validationFormCheck1 bs-dark-border-subtle">Согласие на обработку персональных данных</label>
                        <div className="invalid-feedback">Обязательное поле</div>
                    </div>
                    <button type="submit" className=" btn bg-primary text-white">Зарегистрироваться</button>
                </form>
