  ...
  >
    Подписка на новости
            ...
            <form id="sab" className="w-50 m-auto p-3" style={{ 'minWidth': '300px' }}onSubmit={load}>
                ...
                <button type="submit" className="btn color bg-primary text-white">Подписаться</button>
            </form>
            <div className="alert  d-none w-50 m-auto p-3 color bg-primary text-white" role="alert" rev={message} id="message">
